...
namespace TournamentManagerPro
{
    ...
    internal class ChampionsLeagueModel : Form
    {
         ...
         * 
         */
        public ChampionsLeagueModel() { BuildInterface(); }
        ...
        private void BuildInterface()
        {
            ...
            BackgroundImage = SetImage(Properties.Resources.championsLg, 0.8f);
            ...
            manage.Click += (sender, eventArgs) => { ManageTeams(slots, new Database().champions); };
            ...
            fastManage.Click += (sender, eventArgs) => 
            {
                if (
                   MessageBox.Show(
                    ...
                    FastManage(slots, new Database().champions);
                }
            };
